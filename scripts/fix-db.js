...
async function fixDB() {
  // Borrar todos los proyectos y recrear con datos correctos
  ...
  const projects = [
    ...
    [16, 'FECTI/2025/C02-IBA//001', 'C02-IBA', 'Soto y ciencia: innovación analítica por RMN para control de calidad y proyección regional', 500000.00],
  ...
  console.log(`${count[0].total} projects inserted.`)
}
