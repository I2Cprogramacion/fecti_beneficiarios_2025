...
async function migrate() {
  ...
  // Drop and recreate projects table with full schema
  await sql`
  ...
  await sql`ALTER TABLE projects ADD COLUMN IF NOT EXISTS num INTEGER NOT NULL DEFAULT 0`
  await sql`ALTER TABLE projects ADD COLUMN IF NOT EXISTS componente VARCHAR(20) NOT NULL DEFAULT ''`
  await sql`ALTER TABLE projects ADD COLUMN IF NOT EXISTS monto NUMERIC(14,2) NOT NULL DEFAULT 0`
  ...
  // Seed 62 official FECTI 2025 beneficiary projects
  // num, clave, componente, titulo, monto
  const projects = [
    ...
    [23, 'FECTI/2025/C02-IBA//018',   'C02-IBA',  'Sistema micelar dirigido como vehículo portador de fármacos hidrófobos', 500000.00],
    ...
    [50, 'FECTI/2025/C04-IYE//034',   'C04-IYE',  'Invernadero 4.0 utcj sustentable', 1500000.00],
    [51, 'FECTI/2025/C04-IYE//057',   'C04-IYE',  'Sistema de Cálculos Ambientales', 591209.33],
    [52, 'FECTI/2025/C04-IYE//063',   'C04-IYE',  'Prototipo de desarrollo de vivienda modelo biofílico escalable de alta eficiencia energética', 919300.00],
    [53, 'FECTI/2025/C04-IYE//077',   'C04-IYE',  'Desarrollo de Plásticos de Ingeniería para Mecanizado Industrial a partir de Residuos Textiles Industriales', 1462472.31],
    [54, 'FECTI/2025/C04-IYE//078',   'C04-IYE',  'Parche transdérmico para regeneración de piel y liberación de fármacos. Maduración tecnológica', 1493000.00],
    [55, 'FECTI/2025/C04-IYE//098',   'C04-IYE',  'Desarrollo de materiales microestructurados basados en zeolita clinoptilolita modificada para la formulación de estuco de alta resistencia térmica', 1484798.84],
    [56, 'FECTI/2025/C04-IYE//099',   'C04-IYE',  'Fortalecimiento de las capacidades de DTA-Agrícola para la manufactura de dispositivos de agricultura de precisión y análisis edafoclimático.', 650000.00],
    [57, 'FECTI/2025/C04-IYE//102',   'C04-IYE',  'Desarrollo de un sistema automático de decapado de pinturas y recubrimientos basado en Solvólisis Termoreactiva para la industria automotriz y aeroespacial.', 1490000.00],
    [58, 'FECTI/2025/C04-IYE//113',   'C04-IYE',  'Integración de un modelo de análisis documental para eficientar el proceso aprobación de partes en la industria de manufactura usando inteligencia artificial.', 764645.00],
    [59, 'FECTI/2025/C04-IYE//115',   'C04-IYE',  'Centro Avanzado de Diagnóstico Predictivo, Manufactura Aditiva y Mantenimiento Inteligente para los Sectores Aeroespacial, Automotriz y Tecnológico.', 1500000.00],
    [60, 'FECTI/2025/C04-IYE//117',   'C04-IYE',  'INNOVAGRO 4.0', 1038304.71],
    [61, 'FECTI/2025/C04-IYE//120',   'C04-IYE',  'Treitus Call - Plataforma de automatización telefónica con inteligencia artificial', 1500000.00],
    [62, 'FECTI/2025/C04-IYE//123',   'C04-IYE',  'Centro de Comercio Inteligente', 1500000.00],
  ]
