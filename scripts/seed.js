...
async function seed() {
  ...
  try {
    ...
    // Seed projects
    console.log('📦 Seeding 62 FECTI 2025 projects...');
    const projects = [
    ...
    const submissions = await sql`SELECT COUNT(*) as total FROM submissions`;

    console.log('\n✅ Database seeding completed successfully!');
    console.log(`   - Projects: ${count[0].total}`);
    console.log(`   - Users: ${users[0].total}`);
    console.log(`   - Submissions: ${submissions[0].total}`);
